...
import { extractWord, offsetToWordCursor, validateLineCursor } from '../blanks/spellchecker'
import selection from '../selection'

const blanksApi = ContentState => {
  /**
   ...
   * is currently used to replace a misspelled word in Blanks that was selected
   * by Chromium.
   *
