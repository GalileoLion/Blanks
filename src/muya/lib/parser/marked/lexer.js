      ...
      for (; i < l; i++) {
        ...
        if (i === 0) {
          ...
          (
            ...
            // Changing to/from task list item from/to bullet, starts a new list(work for blanks issue #870)
            // Because we distinguish between task list and bullet list in Blanks,
