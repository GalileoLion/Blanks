<template>
  <div class="pref-keybindings">
    ...
    <section class="keybindings">
      <div class="text">
        Customize Blanks shortcuts and click on the save button below to apply all changes (requires a restart).
...
export default {
  ...
  mounted () {
    ...
    this.showDebugTools = global.blanks.env.debug
  },
  ...
  methods: {
    openKeybindingWiki () {
      shell.openExternal('https://github.com/blanks/blanks/blob/master/docs/KEYBINDINGS.md')
    },
    saveKeybindings () {
