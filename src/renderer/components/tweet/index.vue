...
export default {
  ...
  methods: {
    ...
    reportViaGithub () {
      shell.openExternal('https://github.com/blanks/blanks/issues/new')
    },
    reportViaTwitter () {
      ...
      const params = {
        via: 'blanksme',
        url: encodeURI('https://github.com/blanks/blanks/'),
        text: value
      }

      if (selectedFace === 'smile') params.hashtags = 'happyBlanks'
