...
- [ ] **Sidebar UI**: 完善侧边栏 UI，优化并缩小侧边栏所占的体积宽度
- [ ] **Title Bar**: 修改应用标题栏 (Title Bar) 的视觉样式
- [ ] **Popup Menu**: 修改文本被选中时出现的弹出菜单 (Popup Menu) 的内容与样式
- [ ] **Themes**: 新增一个全新的应用配色主题 (Color Theme)
- [ ] **TOC**: 在编辑器边距区加入透明悬浮的窄圆角矩形，用于快捷显示和操作 Table Of Contents (TOC)
- [ ] **Footer Search**: 在底栏 (Footer Bar) 文字按钮区加入“搜索”按钮，点击可直接调用侧边栏搜索功能
- [ ] **Footer AI**: 在底栏 (Footer Bar) 文字按钮区加入“AI”按钮，点击可直接唤出侧边栏 AI 助手
